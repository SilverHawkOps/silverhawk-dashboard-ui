...
export const navItems = [
  {
    ...
    path: "/docs",
    description: "Introduction and quick start guide for Silverhawk APM",
  },
  {
    ...
    subItems: [
      {
        ...
        description: "Step-by-step guide to create and connect your infrastructure",
      },
      {
        name: "Agent Installation",
        path: "/docs/tutorials/infra/agent-installation",
        description: "Install and configure the silverhawk-infra agent",
      },
      {
        name: "Metrics Overview",
        path: "/docs/infrastructure/metrics",
        description: "Understand CPU, memory, disk, and network metrics",
      },
      {
        name: "Troubleshooting",
        path: "/docs/infrastructure/troubleshooting",
        description: "Fix connectivity or data collection issues",
      },
    ],
  },
  {
