...
const HeroSection = () => {
  return (
    <section className="relative flex flex-col items-center justify-center text-center min-h-[85vh] px-6 overflow-hidden bg-gradient-to-b from-[#0a0f14] via-[#0f1620] to-[#0a0f14]">
      ...
      >
        Unified <span className="text-blue-400">Infrastructure & Synthetic Monitoring</span>
      </motion.h1>
      ...
      >
        SilverHawk APM monitors your servers, APIs, and websites — tracking uptime, SSL health, and page performance
        in real-time. Get proactive alerts before your users even notice issues.
      </motion.p>
      ...
      >
        <Stat number="3.2B+" label="Metrics Processed / Day" />
        <Stat number="<200ms" label="Monitoring Latency" />
        <Stat number="99.99%" label="Global Availability" />
        <Stat number="15+" label="Regions Covered" />
      </motion.div>
    </section>
  );
