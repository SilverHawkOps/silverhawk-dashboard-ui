"use client";
import { ClipboardCopyIcon, Copy } from "lucide-react";
...
const CodeBlock = ({ code, language = "bash" }: { code: string, language?: string; }) => {
  ...
  return (
    <div>
      <div className="bg-gray-200 text-black text-sm rounded-sm mt-4 overflow-x-auto dark:bg-gray-800 dark:text-gray-100">
