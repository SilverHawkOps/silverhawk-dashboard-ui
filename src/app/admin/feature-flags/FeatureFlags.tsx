...
import { ActivityIcon, AppWindowIcon, Edit, FlagIcon, LayoutIcon, PlusIcon, SettingsIcon, Trash, UserIcon } from "lucide-react";
...
const FeatureFlags = () => {
    ...
    if (queryLoading) return <p>Loading feature flags...</p>;
    if (queryError) return <p>Error fetching feature flags</p>;


    const renderFlagList = (data, key) => {
        ...
        <div className="bg-gray-50 dark:bg-gray-900 space-y-2">
            ...
            <div className="flex justify-between items-center mb-6">
                ...
                <Link href={"/dashboard/add-new-infrastructure"} className="flex items-center gap-2">
                    <Button className="w-full" size="xs" startIcon={<PlusIcon />} onClick={() => setIsOpen(true)}>
                        Add New
                    </Button>
                </Link>
