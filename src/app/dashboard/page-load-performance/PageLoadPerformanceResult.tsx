...
interface PageLoadPerformanceResultProps {
  performanceData: PerformanceData;
}

const PageLoadPerformanceResult: React.FC<PageLoadPerformanceResultProps> = ({ performanceData }) => {
              ...
              <div className="flex items-center justify-end sm:ml-6 mt-3 sm:mt-0 min-w-[120px]">
                <div className="w-14 h-14">
                  <CircularProgressbar
                    ...
                    styles={buildStyles({
                      pathColor:
                        audit.score && audit.score >= 0.9
                          ? "#10B981"
                          : audit.score && audit.score >= 0.5
                            ? "#F59E0B"
                            : "#EF4444",
                      textColor: "#111827",
                      trailColor: "#E5E7EB",
